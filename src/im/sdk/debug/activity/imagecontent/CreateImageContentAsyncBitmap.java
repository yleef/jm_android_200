...
import im.sdk.debug.utils.GetImageAndMusicUtil;
...
/**#################    加载assets文件夹中的图片    #################*/
        mBt_getImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GetImageAndMusicUtil.getImage(getApplicationContext());
                mTv_showImagePath.append("path = " + GetImageAndMusicUtil.mFileDirectory);
