                ...
                customMessage.setOnSendCompleteCallback(new BasicCallback() {
                    ...
                    public void gotResult(int i, String s) {
                        if (i == 0) {
                            ...
                            Log.i("CreateSigCustomMsgActivity", "JMessageClient.createSingleCustomMessage" + ", responseCode = " + i + " ; LoginDesc = " + s);
                        }else {
                            Toast.makeText(getApplicationContext(), "发送失败", Toast.LENGTH_SHORT).show();
                            Log.i("CreateSigCustomMsgActivity", "JMessageClient.createSingleCustomMessag" + ", responseCode = " + i + " ; LoginDesc = " + s);
                        }
                    }
                });
