                ...
                JMessageClient.addUsersToBlacklist(mList, mAppKey, new BasicCallback() {
                    ...
                    public void gotResult(int i, String s) {
                        if (i == 0) {
                            ...
                            mProgressDialog.dismiss();
                            Log.i("AddRemoveBlackListActivity", "JMessageClient.addUsersToBlacklist " + ", responseCode = " + i + " ; LoginDesc = " + s);
                ...
                JMessageClient.delUsersFromBlacklist(mList, mAppKey, new BasicCallback() {
                    ...
                    public void gotResult(int i, String s) {
                        if (i == 0) {
                            ...
                            Log.i("AddRemoveBlackListActivity", "JMessageClient.delUsersFromBlacklist " + ", responseCode = " + i + " ; LoginDesc = " + s);
                            mProgressDialog.dismiss();
