...
import com.wepinche.jmus.controller.FriendInfoController;
...
import com.wepinche.jmus.view.FriendInfoView;
...
public class FriendInfoActivity extends BaseActivity {
    ...
    public void startChatActivity() {
        if (mIsFromContact) {
            ...
            intent.putExtra(JChatDemoApplication.CONV_TITLE, title);
            ...
            if (mGroupId != 0) {
                ...
                intent.putExtra(JChatDemoApplication.CONV_TITLE, mTitle);
