...
import com.wepinche.jmus.activity.AudioFragment;
import com.wepinche.jmus.activity.DocumentFragment;
import com.wepinche.jmus.activity.ImageFragment;
import com.wepinche.jmus.activity.OtherFragment;
import com.wepinche.jmus.activity.SendFileActivity;
import com.wepinche.jmus.activity.VideoFragment;
import com.wepinche.jmus.adapter.ViewPagerAdapter;
...
import com.wepinche.jmus.listener.UpdateSelectedStateListener;
...
public class SendFileController implements View.OnClickListener, ViewPager.OnPageChangeListener,
    ...
    public SendFileController(SendFileActivity context, SendFileView view) {
        ...
        String targetId = mContext.getIntent().getStringExtra(JChatDemoApplication.TARGET_ID);
        String targetAppKey = mContext.getIntent().getStringExtra(JChatDemoApplication.TARGET_APP_KEY);
        long groupId = mContext.getIntent().getLongExtra(JChatDemoApplication.GROUP_ID, 0);
        if (groupId != 0) {
            ...
            if (controller != null) {
                switch (msg.what) {
                    case SEND_FILE:
                        ...
                        intent.putExtra(JChatDemoApplication.MsgIDs, controller.mMsgIds);
                        controller.mContext.setResult(JChatDemoApplication.RESULT_CODE_SEND_FILE, intent);
